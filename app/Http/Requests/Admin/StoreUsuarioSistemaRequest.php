...
class StoreUsuarioSistemaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'username' => ['required', 'string', 'max:60', 'alpha_dash:ascii', Rule::unique('users', 'username')],
    ...
    public function after(): array
    {
        return [function ($validator) {
            ...
            if ($currentPassword === '') {
                $validator->errors()->add('current_password', 'Confirma tu contraseña actual para crear usuarios con rol de alta jerarquía.');
                return;
            }
