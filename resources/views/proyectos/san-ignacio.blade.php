...
@section('title', 'Residencial San Ignacio — Beatriz Campos Inmobiliaria')
...
<section class="proy-hero">
    <div class="proy-hero-wrap">
        <div>
            ...
            <h1 class="proy-h1">Residencial<br><span>San Ignacio</span></h1>
            ...
            <div style="display:flex;gap:14px;flex-wrap:wrap;">
                <a href="https://wa.me/51929303999?text=Hola!%20Me%20interesa%20el%20Residencial%20San%20Ignacio" target="_blank" class="btn-wa-big" style="font-size:14px;padding:13px 28px;">
                    <i class="fab fa-whatsapp"></i> Consultar ahora
                </a>
                <a href="https://share.google/jlARcoaQqVfnyC3qR" target="_blank" class="btn-maps">
...
<section id="galeria">
    <div class="wrap">
        ...
        <div class="gal-grid-p">
            <div class="gal-item-p"><img src="{{ asset('imagenes/imagenes_website/proyecto-lotes-hualhuas-35k.jpeg') }}" alt="Vista del proyecto"></div>
...
<section id="mapa">
    <div class="wrap">
        ...
        <div class="mapa-box">
            <img src="{{ asset('imagenes/imagenes_website/mapa-llegar.jpeg') }}" alt="Mapa ubicación Residencial San Ignacio">
        </div>
        <div class="mapa-cta">
            <a href="https://share.google/jlARcoaQqVfnyC3qR" target="_blank" class="btn-maps" style="margin-top:0;">
...
<section id="cta-proy">
    <div class="wrap">
        <div style="text-align:center;">
            ...
            <h2 class="s-h2" style="color:#fff;margin-bottom:12px;">¿Te interesa <span style="color:var(--mg);">Residencial San Ignacio</span>?</h2>
            ...
            <a href="https://wa.me/51929303999?text=Hola!%20Me%20interesa%20el%20Residencial%20San%20Ignacio%20y%20quisiera%20agendar%20una%20visita" target="_blank" class="btn-wa-big">
